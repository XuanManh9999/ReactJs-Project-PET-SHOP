...
import { faDongSign, faRightLong, faMagnifyingGlassPlus, faCartPlus } from "@fortawesome/free-solid-svg-icons";
                    ...
                    <div className={styles['product-buy-list']}>
                        <div className={styles['product-cat']}>
                            ...
                            <div className={styles['producitem']}>
                                ...
                                <div className={styles.price}>
                                    <div className={styles['line-clamp-2']}>
                                        <Link to={""}>Thức ăn hạt cho mèo Whiskat.</Link>
                                    </div>
                            ...
                            <div className={styles['producitem']}>
                                ...
                                <div className={styles.price}>
                                    <div className={styles['line-clamp-2']}>
                                        <Link to={""}>Thức ăn hạt cho mèo Nutrience Original.</Link>
                                    </div>
                                    <div className={styles['price-item-many']}>
                                        <span className={styles['price-new']}>
                                            130.000
                            ...
                            <div className={styles['producitem']}>
                                ...
                                <div className={styles.price}>
                                    <div className={styles['line-clamp-2']}>
                                        <Link to={""}>Thức ăn hạt khô cho mèo MININO.</Link>
                                    </div>
                                    <div className={styles['price-item-many']}>
                                        <span className={styles['price-new']}>
                                            90.000
                            ...
                            <div className={styles['producitem']}>
                                ...
                                <div className={styles.price}>
                                    <div className={styles['line-clamp-2']}>
                                        <Link to={""}>Xương gặp tự nhiên vị gà Ferplast Goodbite.</Link>
                                    </div>
                                    <div className={styles['price-item-many']}>
                                        <span className={styles['price-new']}>
                                            63.000
                            ...
                            <div className={styles['producitem']}>
                                ...
                                <div className={styles.price}>
                                    <div className={styles['line-clamp-2']}>
                                        <Link to={""}>Thức ăn cho mèo Royal Canin Hairball Care.</Link>
                                    </div>
                                    <div className={styles['price-item-many']}>
                                        <span className={styles['price-new']}>
                                            459.000
