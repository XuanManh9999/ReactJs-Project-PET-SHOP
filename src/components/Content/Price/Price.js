    ...
    <section>
      <div className={styles['price_pandemic']}>
        <div className={styles['main-content']}>
          ...
          <img
            src="https://i.ibb.co/GWwGSbR/cat-sub-hero-top.png"
            alt="Chào mừng bạn đến với Catchy Pet"
            className={styles['hero_cat_top_products']}
          />
          ...
          <img
            src="https://i.ibb.co/0hWYz8s/cat-sub-hero-bottom.png"
            alt="Chào mừng bạn đến với Catchy Pet"
            className={styles['hero_cat_bottom_products']}
          />
        </div>
      </div>
    </section>
